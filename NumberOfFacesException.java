 ...
 * object for when the number of faces requested is zero or less.
 * It allows the storing and accessing of the error message.
 * @author Dee Dee McCroskeu
 *@since 09/16/16
 */
public class NumberOfFacesException extends Exception {
     ...
     */
	public NumberOfFacesException(String message)
	{
		super(message);
